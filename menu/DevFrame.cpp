...
void Func_ReturnFromDevFrame();

#define NUM_FRAME_BUTTONS 4
#define FRAME_BUTTONS devFrameButtons
#define FRAME_STRINGS devFrameStrings
...
{ //	button	buttonString		x		y		width	height	Up	Dwn	Lft	Rt	clickFunc					returnFunc
	{	NULL,	FRAME_STRINGS[1],	150.0,	 50.0,	340.0,	40.0,	 3,	 1,	-1,	-1,	Func_ToggleFPS,				Func_ReturnFromDevFrame }, // 
	{	NULL,	FRAME_STRINGS[3],	150.0,	150.0,	340.0,	40.0,	 0,	 2,	-1,	-1,	Func_ToggleScreenDebug,		Func_ReturnFromDevFrame }, // 
	{	NULL,	FRAME_STRINGS[7],	150.0,	250.0,	340.0,	40.0,	 1,	 3,	-1,	-1,	Func_ToggleVILimit,			Func_ReturnFromDevFrame }, // 
	{	NULL,	FRAME_STRINGS[9],	150.0,	350.0,	340.0,	40.0,	 2,	 0,	-1,	-1,	Func_ToggleGlN64useFbTex,	Func_ReturnFromDevFrame }, // 
};
